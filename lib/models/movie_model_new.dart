...
MovieModelNew movieModelNewFromJson(String str) =>
    MovieModelNew.fromJson(json.decode(str));

String movieModelNewToJson(MovieModelNew data) => json.encode(data.toJson());
...
class MovieModelNew {
  ...
  factory MovieModelNew.fromJson(Map<String, dynamic> json) => MovieModelNew(
        result:
